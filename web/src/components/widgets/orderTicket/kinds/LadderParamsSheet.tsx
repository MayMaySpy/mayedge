    ...
    <FieldGroup className="gap-3">
      ...
      {preview && (
        <div className="flex items-center justify-between gap-2">
          <p className="min-w-0 font-mono text-xs text-muted-foreground">{preview}</p>
          <Button
            type="button"
            variant="ghost"
            size="sm"
            ...
            className="h-auto shrink-0 px-1 py-0 text-xs font-medium text-muted-foreground hover:text-text"
          >
            Preview
          </Button>
        </div>
